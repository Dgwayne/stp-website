    ...
    <main className="mx-auto max-w-3xl px-6 pt-28 pb-20">
      ...
      <div className="prose-custom space-y-8 text-muted leading-relaxed">
        ...
        <section>
          ...
          <p>
            To understand which features matter and where performance needs
            work, the App collects anonymous usage statistics: which features,
            map layers, and data products are opened; session length; app
            version; device model, operating system version, screen size, and
            memory; and performance measurements such as frame-rate and memory
            usage. This data is keyed to a random identifier generated by the
          ...
          <p className="mt-3">
            <strong className="text-foreground">You control this:</strong>{" "}
            usage statistics can be turned off at any time in Settings &rarr;
            Privacy &rarr; &quot;Share anonymous usage statistics.&quot;
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              ...
              third-party analytics, advertising, or cross-app tracking SDKs,
              and the App shows no ads. The only usage data collected is the
              first-party anonymous statistics described above, which you can
              ...
              <tbody className="divide-y divide-white/5">
                ...
                <tr>
                  ...
                  <td className="py-3 pr-4">
                    ...
                    shared location, avatar, username, and bio), the anonymous
                    usage statistics service, and delivery of weather imagery
                  </td>
                  <td className="py-3">
                    <a
        ...
        <section>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              ...
              Anonymous usage statistics are stored on our Cloudflare-hosted
              service in the United States, keyed only to a random install
              identifier, and can be turned off in Settings. Aside from
              Supabase (accounts), Sentry (crash reports), and Cloudflare
              (presence, usage statistics, weather imagery), all other network
